...
export { IgcCalendarResourceStringEN, type IgcCalendarResourceStrings, } from './components/common/i18n/EN/calendar.resources.js';
export { IgcDateRangePickerResourceStringsEN, type IgcDateRangePickerResourceStrings, } from './components/common/i18n/EN/date-range-picker.resources.js';
export { IgcChatResourceStringEN, type IgcChatResourceStrings, } from './components/common/i18n/EN/chat.resources.js';
export { type ICalendarResourceStrings, type ICarouselResourceStrings, type IChipResourceStrings, type IComboResourceStrings, type IDateRangePickerResourceStrings, type IFileInputResourceStrings, type ITreeResourceStrings, CalendarResourceStringsEN, CarouselResourceStringsEN, ChipResourceStringsEN, ComboResourceStringsEN, DateRangePickerResourceStringsEN, FileInputResourceStringsEN, TreeResourceStringsEN, registerI18n, setCurrentI18n, } from 'igniteui-i18n-core';
...
export type { CalendarActiveView, CalendarHeaderOrientation, CalendarSelection, DateRangeDescriptor, WeekDays, } from './components/calendar/types.js';
...
export type { CustomDateRange, DateRangeValue, } from './components/date-range-picker/date-range-picker.js';
...
export type { IgcActiveStepChangingEventArgs, IgcActiveStepChangedEventArgs, } from './components/stepper/stepper.common.js';
export type { IgcTreeSelectionEventArgs } from './components/tree/tree.common.js';
export type { ComboItemTemplate, ComboTemplateProps, FilteringOptions, GroupingDirection, IgcComboChangeEventArgs, } from './components/combo/types.js';
