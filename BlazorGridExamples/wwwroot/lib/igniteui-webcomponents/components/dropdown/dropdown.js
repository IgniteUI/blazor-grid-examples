...
let IgcDropdownComponent = class IgcDropdownComponent extends EventEmitterMixin(IgcBaseComboBoxLikeComponent) {
    static { IgcDropdownComponent_1 = this; }
    static { this.tagName = 'igc-dropdown'; }
