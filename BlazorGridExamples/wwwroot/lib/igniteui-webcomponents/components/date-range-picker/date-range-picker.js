...
import { IgcDateRangePickerResourceStringsEN, } from '../common/i18n/EN/date-range-picker.resources.js';
...
let IgcDateRangePickerComponent = class IgcDateRangePickerComponent extends FormAssociatedRequiredMixin(EventEmitterMixin(IgcBaseComboBoxLikeComponent)) {
    static { IgcDateRangePickerComponent_1 = this; }
    ...
    _delegateInputsValidity() {
        ...
        inputs.forEach((input) => {
            input.checkValidity = () => !this._pristine ? this.checkValidity() : true;
            input.reportValidity = () => !this._pristine ? this.reportValidity() : true;
        });
    }
    _setDateConstraints() {
        this._dateConstraints =
    ...
    render() {
        ...
        return html `${cache(!this.useTwoInputs
...
__decorate([
    property()
], IgcDateRangePickerComponent.prototype, "locale", null);
__decorate([
    property({ attribute: false })
], IgcDateRangePickerComponent.prototype, "resourceStrings", null);
__decorate([
