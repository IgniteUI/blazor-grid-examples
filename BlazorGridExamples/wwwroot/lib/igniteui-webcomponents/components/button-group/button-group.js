...
export default class IgcButtonGroupComponent extends EventEmitterMixin(LitElement) {
    static { this.tagName = 'igc-button-group'; }
    ...
    _observerCallback({ changes: { added, attributes }, }) {
        ...
        const idx = buttons.indexOf(added.length ? last(added).node : last(attributes).node);
