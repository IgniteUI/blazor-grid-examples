...
var IgcToggleButtonComponent_1;
...
let IgcToggleButtonComponent = class IgcToggleButtonComponent extends LitElement {
    static { IgcToggleButtonComponent_1 = this; }
    static { this.styles = [styles, shared]; }
    static { this.tagName = 'igc-toggle-button'; }
    static register() {
        registerComponent(IgcToggleButtonComponent_1);
    }
    constructor() {
        super();
...
IgcToggleButtonComponent = IgcToggleButtonComponent_1 = __decorate([
