...
export default class IgcStepComponent extends LitElement {
    ...
    async toggleAnimation(type, direction = 'normal') {
        ...
        const result = await Promise.all([
            this.bodyAnimationPlayer.playExclusive(bodyAnimation({ keyframe: options, step })),
            this.contentAnimationPlayer.playExclusive(contentAnimation({ keyframe: options, step })),
        ]);
