...
import { addSafeEventListener, findElementFromEventPath, isLTR, } from '../common/util.js';
...
export default class IgcTreeItemComponent extends LitElement {
    static { this.tagName = 'igc-tree-item'; }
    static { this.styles = [styles, shared]; }
    static register() {
        registerComponent(IgcTreeItemComponent, IgcIconComponent, IgcCheckboxComponent, IgcCircularProgressComponent);
    }
        ...
        <div part=${partMap(indicatorParts)} aria-hidden="true">
          ${this.loading
            ...
            : html `
                ...
                ? html `
                        <igc-icon
                          aria-label=${ifDefined(this.expanded
