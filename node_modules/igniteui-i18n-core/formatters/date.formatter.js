...
export class DateFormatter extends BaseFormatter {
    defaultCustomFormatOptions = {
        forceLeadingZero: false,
        timezone: 'GMT',
    };
    localeFormatter;
    constructor(defaultLocale, localeFormatter) {
     ...
     * @returns
     */
    getLocaleDateTimeFormat(locale, forceLeadingZero = false, dateTimeOptions) {
     ...
     * @returns
     */
    formatDateCustomFormat(value, format, options) {
        let parts = [];
        let match;
    ...
    formatPartialDateValue(date, format, formatOptions) {
        ...
        if (options.hour) {
            ...
            if (!formatOptions.forceLeadingZero &&
