...
export declare const GRID_PREFIX = "grid_";
export declare const IGX_PREFIX = "igx_";
 ...
 */
export declare const customFormatRegex: RegExp;
 ...
 */
export declare const isoRegex: RegExp;
export declare function generateLocaleKey(locale: string, formatterOptions?: Intl.NumberFormatOptions | Intl.DateTimeFormatOptions): string;
/**
 ...
 */
export declare function mergeOptions<T extends Intl.NumberFormatOptions | Intl.DateTimeFormatOptions | Intl.DisplayNamesOptions>(target: T, source?: T): T;
/**
 ...
 */
export declare function extendResources<T, E>(baseObject: T, ...extendedObjects: E[]): T & E;
export declare function prefixResource<T, P extends string>(prefix: P, inObject: T): PrefixedResourceStrings<T, P>;
