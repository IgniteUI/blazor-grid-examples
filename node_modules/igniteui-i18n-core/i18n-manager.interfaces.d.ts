...
export declare const I18nManagerEventTarget: {
...
export type IntlFormatter<T, O> = (new (locale: string | Intl.Locale, options?: O) => T) | (new (locale: Intl.LocalesArgument, options: O) => T);
